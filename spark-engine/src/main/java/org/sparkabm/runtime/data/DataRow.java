...
public final class DataRow implements Serializable {
    ...
    public DataObject_Spaces getSpaces() {
        DataObject obj = data.get(DataCollectorDescription.STR_SPACES);
        if (obj == null)
            return null;
        else
...
//		String name = "$data-layer:" + spaceName + ":" + dataLayerName;
        String name = DataCollectorDescription.STR_DATA_LAYER + dataLayerName;
    ...
    public DataObject_SpaceAgents getSpaceAgents(String typeName) {
        String name = DataCollectorDescription.STR_SPACE_AGENTS + typeName;
    ...
    public DataObject_AgentData getAgentData(String typeName) {
        String name = DataCollectorDescription.STR_AGENT_DATA + typeName;
    ...
    public DataObject_Inspection getInspectionData(String name) {
        String dataName = DataCollectorDescription.STR_INSPECTION_DATA + name;
    ...
    public Integer getNumberOfAgents(String typeName) {
        String name = DataCollectorDescription.STR_NUMBER_OF_AGENTS + typeName;
        DataObject obj = data.get(name);
        if (obj == null)
            return null;
        else
    ...
    public Double getVarDoubleValue(String varName) {
        String name = DataCollectorDescription.STR_VARIABLE + varName;
