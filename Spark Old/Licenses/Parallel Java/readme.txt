...
The documentation files, Java source files, and Java class files in the Parallel Java Library ("PJ") are copyright © 2005-2009 by Alan Kaminsky. All rights reserved. For further information, contact the author, Alan Kaminsky, at ark­@­cs.rit.edu.
