 ...
 */
public class GridSpace extends BoundedSpace {
	private static final long serialVersionUID = 172987287392956066L;
	 ...
	 * @param wrapY
	 */
	public GridSpace(double xMin, double xMax, 
		...
		if (Math.floor(xMin) != xMin ||
			...
			Math.floor(yMax) != yMax)
				throw new Error("NetLogoSpace: non-integer dimensions");
