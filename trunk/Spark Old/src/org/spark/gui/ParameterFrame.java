...
public class ParameterFrame extends UpdatableFrame implements ChangeListener, ActionListener {
	...
	public ParameterFrame(Node node, JFrame owner) {
...
//	@SuppressWarnings("unchecked")
	private void addParameter(Node node) {
		...
		try {
			...
			get = GUIModelManager.getModelClass().getMethod(sget);
			set = GUIModelManager.getModelClass().getMethod(sset, type);
