...
//	private static final Logger logger = Logger.getLogger();
	...
	private static class VariableValue {
		/* Variable */
		public ProxyVariable var;
		/* Variable's value in the string format */
		public String svalue;
		
		public VariableValue(ProxyVariable var, String svalue) {
			this.var = var;
			this.svalue = svalue;
		}
		
		public VariableValue(ProxyVariable var) {
			this.var = var;
	 ...
	 * @param svalue
	 */
	void addVariable(ProxyVariable var, String svalue) {
	 ...
	 */
	public void synchronizeWithParameters(ParameterCollection parameters) {
		Parameter[] pars = parameters.getParameters();
